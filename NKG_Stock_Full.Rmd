...
# Import data
```{r}
train <- read_excel("C:/Users/LeHuyPhong/Downloads/Train_NKG.xlsx", col_names = FALSE) #use 2 years 2021 and 2022 to train model
hpg_2023 <- read_excel("C:/Users/LeHuyPhong/Downloads/Test_NKG.xlsx", col_names = FALSE)
